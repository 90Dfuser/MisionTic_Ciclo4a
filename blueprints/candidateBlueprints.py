...
@candidate_blueprints.route("/candidate/<string:candidate_id>/political_party/<string:political_party_id>",
                            methods=['PUT'])
def assign_political_party(candidate_id, political_party_id):
