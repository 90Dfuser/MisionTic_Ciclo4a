...
political_parties_blueprint = Blueprint()
political_parties_controller = PoliticalPartyController()


@political_parties_blueprint.route("/political_parties/all", methods=['GET'])
def get_all_political_parties():
    response = political_parties_controller.index()
    return response, 200


@political_parties_blueprint.route("/political_parties/<string: id_>", methods=['GET'])
def get_political_party_by_id(id_):
    response = political_parties_controller.show(id_)
    return response, 200


@political_parties_blueprint.route("/political_parties/insert", methods=['POST'])
...
@political_parties_blueprint.route("/political__parties/update/<string: id_>", methods=['PATCH'])
...
@political_parties_blueprint.route("/political_parties/delete/<string: id_>", methods=['DELETE'])
